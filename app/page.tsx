...
export default function HomePage() {
  return (
    <>
        ...
        <HeroCursorGlow>
          ...
          <div className="hero__content">
            <div className="hero__left">
              ...
              <p className="hero__title compile-el">
                Hardware Engineer Intern @ SubVysion
              </p>
              <p className="hero__status compile-el">
                <span className="hero__status-dot" aria-hidden="true" />
                <span>
                  Seeking a Summer 2027 internship in hardware, IC/VLSI,
                  robotics, or adjacent fields &middot; graduating May 2028
                  &middot; U.S. &amp; German citizen
                </span>
              </p>
            ...
            <div className="hero__right">
              <div className="compile-el">
                <p className="section__label">About me</p>
                <p className="hero__desc">
                  Electrical Engineering at the University of Pennsylvania,
                  working at the intersection of mechanical and electronic
                  design: from embedded firmware and mechanical CAD to the
                  electrical systems that tie them together. What I enjoy most
                  is navigating the tradeoffs between functionality,
                  complexity, and cost.
                </p>
              </div>
              <div className="compile-el">
      ...
      {/* Experience — mobile only (desktop shows it in the hero) */}
      <section
        className="section exp-mobile"
